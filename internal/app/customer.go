...
func registerCustomerRoutes(protected fiber.Router, deps appDependencies) {
	...
	protected.Get("/stores/:storeID/customers/:customerID/shipping-addresses", handler.ListShippingAddresses)
	protected.Post("/stores/:storeID/customers/:customerID/shipping-addresses", handler.CreateShippingAddress)
	protected.Put("/stores/:storeID/customers/:customerID/shipping-addresses/:addrID", handler.UpdateShippingAddress)
	protected.Delete("/stores/:storeID/customers/:customerID/shipping-addresses/:addrID", handler.DeleteShippingAddress)
