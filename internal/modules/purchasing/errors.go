...
var (
	...
	ErrSupplierForbidden       = errors.New("user cannot operate this store")
	ErrSupplierStoreIDReq      = errors.New("storeID is required")
	ErrPONotFound              = errors.New("purchase order not found")
	ErrPOForbidden             = errors.New("user cannot operate this store")
	ErrPOStoreIDRequired       = errors.New("storeID is required")
